...
/***/ function(module, exports, __webpack_require__) {
	...
	var appRootElId = 'app-root';
	var postsDataId = 'postsData';

	function renderComponent(component, rootEl) {
	  if (rootEl) {
	    _reactDom2.default.render(component, rootEl);
	  } else {
	...
	window.onload = function () {
	  ...
	  var appData = dataEl ? JSON.parse(dataEl.innerHTML) : [];
	  renderComponent(_react2.default.createElement(_App2.default, { posts: appData }), document.getElementById(appRootElId));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InfoBox = __webpack_require__(172);
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    key: 'filterItems',
	    value: function filterItems(filterText) {
	      if (filterText) {
	        var filteredPosts = this.props.posts.filter(function (current) {
	          var words = filterText.split(' ');
	          var hasAllWords = true;
	          var hasCurrentWord = function hasCurrentWord(filteredWord) {
	            return current.postContent.toString().toLowerCase().indexOf(filteredWord.toLowerCase()) > -1 || current.postTitle.toString().toLowerCase().indexOf(filteredWord.toLowerCase()) > -1;
	          };
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        this.props.posts.length > 0 ? [_react2.default.createElement(_Search2.default, { key: 1, search: this.filterItems.bind(this) }), _react2.default.createElement(_InfoBox2.default, { key: 3, items: this.props.posts }), _react2.default.createElement(_List2.default, { key: 2, items: this.state.posts })] : null
	      );
	    }
	  }]);
	  ...
	  _createClass(List, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'list' },
	        this.props.items.map(function (current, index) {
	...
	var ListItem = function (_Component) {
	  ...
	  _createClass(ListItem, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      var el = _reactDom2.default.findDOMNode(this.refs.postContent).querySelector('.code-to-copy code');
	      if (el) {
	        /*this.setState({
	          hasCodeToCopy: true,
	        });*/
	        var copyButtonEl = document.createElement('div');
	        copyButtonEl.classList.add('copy-code-button');
	        copyButtonEl.onclick = function () {
	          _this2.copyCodeToClipBoard();
	        };
	        copyButtonEl.innerHTML = 'Copy';
	        console.log(copyButtonEl);
	        _reactDom2.default.findDOMNode(this.refs.postContent).querySelector('.code-to-copy').appendChild(copyButtonEl);
	      }
	    }
	  }, {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('div', { ref: 'postContent', className: 'list-item-body', dangerouslySetInnerHTML: { __html: this.props.content } }),
	        _react2.default.createElement(
	          'div',
	          { className: 'list-item-tags' },
	          this.props.tags.map(function (current, index) {
	            return _react2.default.createElement(
	              'span',
	              { key: index, className: 'list-item-tag' },
	              ' current '
	            );
	          })
	        )
	  ...
	  _createClass(Search, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      document.addEventListener('keydown', function (ev) {
	        ...
	        var el = _reactDom2.default.findDOMNode(_this2.refs.searchInput);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', {
	          ...
	          onKeyUp: function onKeyUp(ev) {
	            return _this3.props.search(ev.target.value);
	          }
	        })
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InfoBoxList = __webpack_require__(173);

	var _InfoBoxList2 = _interopRequireDefault(_InfoBoxList);
	...
	var InfoBox = function (_Component) {
	  ...
	  function InfoBox(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(InfoBox).call(this));
	  ...
	  _createClass(InfoBox, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'infobox-tools' },
	          _react2.default.createElement(
	            'div',
	            { className: 'infobox-toggle hidden' },
	            ' Hide '
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'infobox-mobile-toggle left', onClick: function onClick(ev) {
	                ev.target.classList.toggle('infobox-mobile-toggle-closed');
	                _this2.setState({
	                  isListHidden: !_this2.state.isListHidden
	                });
	              } },
	            ' '
	          ),
	        ...
	        _react2.default.createElement(_InfoBoxList2.default, { isListHidden: this.state.isListHidden, items: this.props.items, ref: 'infoBoxList' })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InfoBoxListItem = __webpack_require__(174);

	var _InfoBoxListItem2 = _interopRequireDefault(_InfoBoxListItem);

	var _InfoBoxListItemTitle = __webpack_require__(176);

	var _InfoBoxListItemTitle2 = _interopRequireDefault(_InfoBoxListItemTitle);
	...
	var InfoBoxList = function (_Component) {
	  _inherits(InfoBoxList, _Component);

	  function InfoBoxList(props) {
	    _classCallCheck(this, InfoBoxList);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(InfoBoxList).call(this));
	  }

	  _createClass(InfoBoxList, [{
	    key: 'componentWillReceiveProps',
	    value: function componentWillReceiveProps(newProps) {}
	  }, {
	    key: 'sortByMonth',
	    value: function sortByMonth(posts) {
	      var resultObj = {};
	      var resultArray = [];
	      for (var i = 0; i < posts.length; i++) {
	        var date = posts[i].postDate.split(' ')[0];
	        var month = date.split('-')[1];
	        var year = date.split('-')[0];
	        var newKey = year + '.' + month;
	        if (resultObj[newKey]) {
	      ...
	      for (var key in resultObj) {
	        if (resultObj[key]) {
	          var titleText = key.split('.');
	          resultArray.push(_react2.default.createElement(_InfoBoxListItemTitle2.default, { key: key, text: titleText[1] + '/' + titleText[0] }));
	          for (var a = 0; a < resultObj[key].length; a++) {
	            resultArray.push(_react2.default.createElement(_InfoBoxListItem2.default, { key: 'infobox-list-item-' + key + a,
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'infobox-list ' + (this.props.isListHidden ? 'infobox-list-hidden' : '') },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InfoBoxListItem = function (_Component) {
	  _inherits(InfoBoxListItem, _Component);

	  function InfoBoxListItem(props) {
	    _classCallCheck(this, InfoBoxListItem);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(InfoBoxListItem).call(this));
	  ...
	  _createClass(InfoBoxListItem, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        this.state.isHovered && this.props.tooltipContent ? _react2.default.createElement(
	          _Tooltip2.default,
	          null,
	          _react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: this.props.tooltipContent } })
	        ) : null,
	        _react2.default.createElement(
	          'a',
	          { href: this.props.url, target: '_blank' },
	  ...
	  return InfoBoxListItem;
	}(_react.Component);

	exports.default = InfoBoxListItem;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tooltip = function (_Component) {
	  ...
	  function Tooltip(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Tooltip).call(this));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InfoBoxListItem = function (_Component) {
	  ...
	  function InfoBoxListItem(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(InfoBoxListItem).call(this));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/*---\n# Only the main Sass file needs front matter (the dashes are enough)\n---\n*/\n/*\n// Import partials from `sass_dir` (defaults to `_sass`)\n@import\n        \"base\",\n        \"layout\",\n        \"syntax-highlighting\"\n;\n*/\n* {\n  box-sizing: border-box; }\n\n#app-root {\n  width: 100%;\n  float: left; }\n\n.hidden {\n  display: none !important; }\n\n.link--light, .infobox-list-item a, .navbar-links-link {\n  color: white; }\n  .link--light:visited, .infobox-list-item a:visited, .navbar-links-link:visited {\n    color: #9b9b9b; }\n    .link--light:visited:hover, .infobox-list-item a:visited:hover, .navbar-links-link:visited:hover {\n      color: #9b9b9b; }\n  .link--light:hover, .infobox-list-item a:hover, .navbar-links-link:hover {\n    color: white; }\n\n.right {\n  float: right; }\n\n.left {\n  float: left; }\n\n.brand-text {\n  font-weight: bold; }\n\n/**\n * Reset some basic elements\n */\nbody, h1, h2, h3, h4, h5, h6,\np, blockquote, pre, hr,\ndl, dd, ol, ul, figure {\n  margin: 0;\n  padding: 0; }\n\n/**\n * Basic styling\n */\nbody {\n  font: 400 16px/1.5 \"Helvetica Neue\", Helvetica, Arial, sans-serif;\n  color: #111;\n  background-color: #fdfdfd;\n  -webkit-text-size-adjust: 100%;\n  -webkit-font-feature-settings: \"kern\" 1;\n  -moz-font-feature-settings: \"kern\" 1;\n  -o-font-feature-settings: \"kern\" 1;\n  font-feature-settings: \"kern\" 1;\n  font-kerning: normal; }\n\n/**\n * Set `margin-bottom` to maintain vertical rhythm\n */\nh1, h2, h3, h4, h5, h6,\np, blockquote, pre,\nul, ol, dl, figure,\n.highlight {\n  margin-bottom: 15px; }\n\n/**\n * Images\n */\nimg {\n  max-width: 100%;\n  vertical-align: middle; }\n\n/**\n * Figures\n */\nfigure > img {\n  display: block; }\n\nfigcaption {\n  font-size: 14px; }\n\n/**\n * Lists\n */\nul, ol {\n  margin-left: 30px; }\n\nli > ul,\nli > ol {\n  margin-bottom: 0; }\n\n/**\n * Headings\n */\nh1, h2, h3, h4, h5, h6 {\n  font-weight: 400; }\n\n/**\n * Links\n */\na {\n  color: #2a7ae2;\n  text-decoration: none; }\n  a:visited {\n    color: #1756a9; }\n  a:hover {\n    color: #111;\n    text-decoration: underline; }\n\n/**\n * Blockquotes\n */\nblockquote {\n  color: #828282;\n  border-left: 4px solid #e8e8e8;\n  padding-left: 15px;\n  font-size: 18px;\n  letter-spacing: -1px;\n  font-style: italic; }\n  blockquote > :last-child {\n    margin-bottom: 0; }\n\n/**\n * Code formatting\n */\npre,\ncode {\n  font-size: 15px;\n  border: 1px solid #e8e8e8;\n  border-radius: 3px;\n  background-color: #eef; }\n\ncode {\n  padding: 1px 5px; }\n\npre {\n  padding: 8px 12px;\n  overflow-x: auto; }\n  pre > code {\n    border: 0;\n    padding-right: 0;\n    padding-left: 0; }\n\n/**\n * Wrapper\n */\n.wrapper {\n  max-width: -webkit-calc(800px - (30px * 2));\n  max-width: calc(800px - (30px * 2));\n  margin-right: auto;\n  margin-left: auto;\n  padding-right: 30px;\n  padding-left: 30px; }\n  @media screen and (max-width: 800px) {\n    .wrapper {\n      max-width: -webkit-calc(800px - (30px));\n      max-width: calc(800px - (30px));\n      padding-right: 15px;\n      padding-left: 15px; } }\n\n/**\n * Clearfix\n */\n.wrapper:after, .footer-col-wrapper:after {\n  content: \"\";\n  display: table;\n  clear: both; }\n\n/**\n * Icons\n */\n.icon > svg {\n  display: inline-block;\n  width: 16px;\n  height: 16px;\n  vertical-align: middle; }\n  .icon > svg path {\n    fill: #828282; }\n\n/**\n * Site header\n */\n.site-header {\n  border-top: 5px solid #424242;\n  border-bottom: 1px solid #e8e8e8;\n  min-height: 56px;\n  position: relative; }\n\n.site-title {\n  font-size: 26px;\n  font-weight: 300;\n  line-height: 56px;\n  letter-spacing: -1px;\n  margin-bottom: 0;\n  float: left; }\n  .site-title, .site-title:visited {\n    color: #424242; }\n\n.site-nav {\n  float: right;\n  line-height: 56px; }\n  .site-nav .menu-icon {\n    display: none; }\n  .site-nav .page-link {\n    color: #111;\n    line-height: 1.5; }\n    .site-nav .page-link:not(:last-child) {\n      margin-right: 20px; }\n  @media screen and (max-width: 600px) {\n    .site-nav {\n      position: absolute;\n      top: 9px;\n      right: 15px;\n      background-color: #fdfdfd;\n      border: 1px solid #e8e8e8;\n      border-radius: 5px;\n      text-align: right; }\n      .site-nav .menu-icon {\n        display: block;\n        float: right;\n        width: 36px;\n        height: 26px;\n        line-height: 0;\n        padding-top: 10px;\n        text-align: center; }\n        .site-nav .menu-icon > svg {\n          width: 18px;\n          height: 15px; }\n          .site-nav .menu-icon > svg path {\n            fill: #424242; }\n      .site-nav .trigger {\n        clear: both;\n        display: none; }\n      .site-nav:hover .trigger {\n        display: block;\n        padding-bottom: 5px; }\n      .site-nav .page-link {\n        display: block;\n        padding: 5px 10px;\n        margin-left: 20px; }\n        .site-nav .page-link:not(:last-child) {\n          margin-right: 0; } }\n\n/**\n * Site footer\n */\n.site-footer {\n  border-top: 1px solid #e8e8e8;\n  padding: 30px 0; }\n\n.footer-heading {\n  font-size: 18px;\n  margin-bottom: 15px; }\n\n.contact-list,\n.social-media-list {\n  list-style: none;\n  margin-left: 0; }\n\n.footer-col-wrapper {\n  font-size: 15px;\n  color: #828282;\n  margin-left: -15px; }\n\n.footer-col {\n  float: left;\n  margin-bottom: 15px;\n  padding-left: 15px; }\n\n.footer-col-1 {\n  width: -webkit-calc(35% - (30px / 2));\n  width: calc(35% - (30px / 2)); }\n\n.footer-col-2 {\n  width: -webkit-calc(20% - (30px / 2));\n  width: calc(20% - (30px / 2)); }\n\n.footer-col-3 {\n  width: -webkit-calc(45% - (30px / 2));\n  width: calc(45% - (30px / 2)); }\n\n@media screen and (max-width: 800px) {\n  .footer-col-1,\n  .footer-col-2 {\n    width: -webkit-calc(50% - (30px / 2));\n    width: calc(50% - (30px / 2)); }\n  .footer-col-3 {\n    width: -webkit-calc(100% - (30px / 2));\n    width: calc(100% - (30px / 2)); } }\n\n@media screen and (max-width: 600px) {\n  .footer-col {\n    float: none;\n    width: -webkit-calc(100% - (30px / 2));\n    width: calc(100% - (30px / 2)); } }\n\n/**\n * Page content\n */\n.page-content {\n  padding: 90px 0; }\n\n.page-heading {\n  font-size: 20px; }\n\n.post-list {\n  margin-left: 0;\n  list-style: none; }\n  .post-list > li {\n    margin-bottom: 30px; }\n\n.post-meta {\n  font-size: 14px;\n  color: #828282; }\n\n.post-link {\n  display: block;\n  font-size: 24px; }\n\n/**\n * Posts\n */\n.post-header {\n  margin-bottom: 30px; }\n\n.post-title {\n  font-size: 42px;\n  letter-spacing: -1px;\n  line-height: 1; }\n  @media screen and (max-width: 800px) {\n    .post-title {\n      font-size: 36px; } }\n\n.post-content {\n  margin-bottom: 30px; }\n  .post-content h2 {\n    font-size: 32px; }\n    @media screen and (max-width: 800px) {\n      .post-content h2 {\n        font-size: 28px; } }\n  .post-content h3 {\n    font-size: 26px; }\n    @media screen and (max-width: 800px) {\n      .post-content h3 {\n        font-size: 22px; } }\n  .post-content h4 {\n    font-size: 20px; }\n    @media screen and (max-width: 800px) {\n      .post-content h4 {\n        font-size: 18px; } }\n\n/**\n * Syntax highlighting styles\n */\n.highlight {\n  background: #fff; }\n  .highlighter-rouge .highlight {\n    background: #eef; }\n  .highlight .c {\n    color: #998;\n    font-style: italic; }\n  .highlight .err {\n    color: #a61717;\n    background-color: #e3d2d2; }\n  .highlight .k {\n    font-weight: bold; }\n  .highlight .o {\n    font-weight: bold; }\n  .highlight .cm {\n    color: #998;\n    font-style: italic; }\n  .highlight .cp {\n    color: #999;\n    font-weight: bold; }\n  .highlight .c1 {\n    color: #998;\n    font-style: italic; }\n  .highlight .cs {\n    color: #999;\n    font-weight: bold;\n    font-style: italic; }\n  .highlight .gd {\n    color: #000;\n    background-color: #fdd; }\n  .highlight .gd .x {\n    color: #000;\n    background-color: #faa; }\n  .highlight .ge {\n    font-style: italic; }\n  .highlight .gr {\n    color: #a00; }\n  .highlight .gh {\n    color: #999; }\n  .highlight .gi {\n    color: #000;\n    background-color: #dfd; }\n  .highlight .gi .x {\n    color: #000;\n    background-color: #afa; }\n  .highlight .go {\n    color: #888; }\n  .highlight .gp {\n    color: #555; }\n  .highlight .gs {\n    font-weight: bold; }\n  .highlight .gu {\n    color: #aaa; }\n  .highlight .gt {\n    color: #a00; }\n  .highlight .kc {\n    font-weight: bold; }\n  .highlight .kd {\n    font-weight: bold; }\n  .highlight .kp {\n    font-weight: bold; }\n  .highlight .kr {\n    font-weight: bold; }\n  .highlight .kt {\n    color: #458;\n    font-weight: bold; }\n  .highlight .m {\n    color: #099; }\n  .highlight .s {\n    color: #d14; }\n  .highlight .na {\n    color: #008080; }\n  .highlight .nb {\n    color: #0086B3; }\n  .highlight .nc {\n    color: #458;\n    font-weight: bold; }\n  .highlight .no {\n    color: #008080; }\n  .highlight .ni {\n    color: #800080; }\n  .highlight .ne {\n    color: #900;\n    font-weight: bold; }\n  .highlight .nf {\n    color: #900;\n    font-weight: bold; }\n  .highlight .nn {\n    color: #555; }\n  .highlight .nt {\n    color: #000080; }\n  .highlight .nv {\n    color: #008080; }\n  .highlight .ow {\n    font-weight: bold; }\n  .highlight .w {\n    color: #bbb; }\n  .highlight .mf {\n    color: #099; }\n  .highlight .mh {\n    color: #099; }\n  .highlight .mi {\n    color: #099; }\n  .highlight .mo {\n    color: #099; }\n  .highlight .sb {\n    color: #d14; }\n  .highlight .sc {\n    color: #d14; }\n  .highlight .sd {\n    color: #d14; }\n  .highlight .s2 {\n    color: #d14; }\n  .highlight .se {\n    color: #d14; }\n  .highlight .sh {\n    color: #d14; }\n  .highlight .si {\n    color: #d14; }\n  .highlight .sx {\n    color: #d14; }\n  .highlight .sr {\n    color: #009926; }\n  .highlight .s1 {\n    color: #d14; }\n  .highlight .ss {\n    color: #990073; }\n  .highlight .bp {\n    color: #999; }\n  .highlight .vc {\n    color: #008080; }\n  .highlight .vg {\n    color: #008080; }\n  .highlight .vi {\n    color: #008080; }\n  .highlight .il {\n    color: #099; }\n\n.list {\n  margin-top: 10px;\n  padding: 10px;\n  float: left;\n  width: 70%; }\n  .list-item {\n    width: 100%;\n    float: left;\n    margin-bottom: 20px; }\n    .list-item-title {\n      color: #464646;\n      font-size: 30px;\n      padding: 10px;\n      width: 100%;\n      float: left; }\n    .list-item-body {\n      word-break: break-word;\n      padding: 10px;\n      width: 100%;\n      float: left; }\n    .list-item-tags {\n      padding: 10px;\n      width: 100%;\n      float: left; }\n    .list-item-tag {\n      padding: 5px;\n      margin: 5px;\n      border-radius: 5px;\n      background-color: #a0a0a0;\n      color: white; }\n    .list-item-details {\n      padding: 10px;\n      float: left;\n      width: 100%; }\n    .list-item-date {\n      float: left;\n      width: 100%; }\n    .list-item-link {\n      float: left;\n      width: 100%; }\n\n@media screen and (max-width: 800px) {\n  .list {\n    width: 100%; } }\n\n.search {\n  float: left;\n  width: 100%;\n  padding: 20px;\n  background-color: #b43232;\n  position: relative; }\n  .search-input {\n    width: 100%;\n    max-width: 300px;\n    padding: 10px;\n    outline: 0;\n    border: 0;\n    color: rgba(255, 255, 255, 0.8);\n    box-shadow: 2px 2px 2px #af2d2d;\n    background-color: rgba(240, 110, 110, 0.1);\n    transition: all 0.2s ease-in; }\n    .search-input::-webkit-input-placeholder {\n      color: #d75555; }\n    .search-input:focus {\n      box-shadow: 2px 2px 2px #aa2828;\n      background-color: rgba(255, 175, 175, 0.1); }\n\n.infobox {\n  padding: 10px;\n  float: right;\n  width: 30%;\n  padding-top: 10px;\n  background-color: #141414; }\n  .infobox-title {\n    float: left;\n    width: 100%;\n    font-size: 20px;\n    color: #464646; }\n  .infobox-list {\n    float: left;\n    width: 100%;\n    margin-left: 0; }\n    .infobox-list-title {\n      color: #464646; }\n    .infobox-list-item {\n      position: relative;\n      display: block;\n      list-style: none;\n      float: left;\n      width: 100%;\n      color: #9b9b9b; }\n      .infobox-list-item a {\n        white-space: nowrap;\n        width: 100%;\n        float: left;\n        overflow: hidden;\n        text-overflow: ellipsis; }\n  .infobox-mobile-toggle {\n    user-select: none;\n    display: none;\n    height: 10px;\n    float: left;\n    position: relative;\n    cursor: pointer;\n    width: 20px;\n    margin-right: 7.5px; }\n    .infobox-mobile-toggle:before {\n      text-align: center;\n      width: 20px;\n      padding: 0 5px 0 5px;\n      background-color: #464646;\n      color: #f0f0f0;\n      position: absolute;\n      left: 50%;\n      transform: translateX(-50%);\n      content: ' + '; }\n    .infobox-mobile-toggle-closed:before {\n      position: absolute;\n      left: 50%;\n      transform: translateX(-50%);\n      content: ' - '; }\n  .infobox-mobile-list-open {\n    height: 100%; }\n  .infobox-mobile-open {\n    height: 100%; }\n\n@media screen and (max-width: 800px) {\n  .infobox {\n    width: 100%; }\n    .infobox .tooltip {\n      display: none; }\n  .infobox-mobile-toggle {\n    display: block; }\n  .infobox-list-hidden {\n    height: 0;\n    overflow: hidden; } }\n\n.navbar {\n  float: left;\n  width: 100%;\n  background-color: #b43232; }\n  .navbar-links ul {\n    outline: 0;\n    padding: 0;\n    margin: 0; }\n    .navbar-links ul li {\n      display: inline-block;\n      margin: 10px; }\n  .navbar-links-link {\n    font-size: 12.5px; }\n    .navbar-links-link:visited {\n      color: white; }\n      .navbar-links-link:visited:hover {\n        color: white; }\n\n.tooltip {\n  position: absolute;\n  width: 300px;\n  height: 300px;\n  left: -320px;\n  z-index: 9999;\n  top: 50%;\n  transform: translateY(-50%);\n  background-color: #141414; }\n  .tooltip-content {\n    font-size: 10px !important;\n    padding: 20px;\n    width: 300px;\n    height: 300px;\n    overflow: hidden;\n    position: absolute; }\n    .tooltip-content code {\n      font-size: 10px; }\n  .tooltip-arrow {\n    width: 0;\n    height: 0;\n    border-top: 10px solid transparent;\n    border-bottom: 10px solid transparent;\n    border-left: 10px solid #141414;\n    top: 50%;\n    transform: translateY(-50%);\n    left: 100%;\n    position: absolute; }\n\n.copy-code-button {\n  color: #b43232;\n  padding: 5px;\n  position: absolute;\n  bottom: 0;\n  right: 0;\n  border: 1px solid #b43232;\n  cursor: pointer;\n  background-color: #b43232;\n  color: white;\n  opacity: 0.5; }\n  .copy-code-button:hover {\n    background-color: #b43232;\n    color: white;\n    opacity: 1; }\n\n.code-to-copy {\n  position: relative; }\n\nbody {\n  background-color: white; }\n", ""]);
